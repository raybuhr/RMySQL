...
// connection_create
XPtr<MyConnectionPtr> connection_create(const Rcpp::Nullable<Rcpp::CharacterVector>& host, const Rcpp::Nullable<Rcpp::CharacterVector>& user, const Rcpp::Nullable<Rcpp::CharacterVector>& password, const Rcpp::Nullable<Rcpp::CharacterVector>& db, unsigned int port, const Rcpp::Nullable<Rcpp::CharacterVector>& unix_socket, unsigned long client_flag, const Rcpp::Nullable<Rcpp::CharacterVector>& groups, const Rcpp::Nullable<Rcpp::CharacterVector>& default_file, const Rcpp::Nullable<Rcpp::CharacterVector>& ssl_key, const Rcpp::Nullable<Rcpp::CharacterVector>& ssl_cert, const Rcpp::Nullable<Rcpp::CharacterVector>& ssl_ca, const Rcpp::Nullable<Rcpp::CharacterVector>& ssl_capath, const Rcpp::Nullable<Rcpp::CharacterVector>& ssl_cipher);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type host(hostSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type user(userSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type password(passwordSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type db(dbSEXP);
    Rcpp::traits::input_parameter< unsigned int >::type port(portSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type unix_socket(unix_socketSEXP);
    Rcpp::traits::input_parameter< unsigned long >::type client_flag(client_flagSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type groups(groupsSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type default_file(default_fileSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type ssl_key(ssl_keySEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type ssl_cert(ssl_certSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type ssl_ca(ssl_caSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type ssl_capath(ssl_capathSEXP);
    Rcpp::traits::input_parameter< const Rcpp::Nullable<Rcpp::CharacterVector>& >::type ssl_cipher(ssl_cipherSEXP);
